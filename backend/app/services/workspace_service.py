...
# PHOENIX PROTOCOL - WORKSPACE SERVICE V1.4 (FULL CLIENT DATA FOR FRONTEND)
# 1. MAPPING: Returns both nested 'client' and flat 'clientName', 'clientEmail', 'clientPhone'.
# 2. CREATION: Builds nested client object, discards flat fields.
# 3. BACKWARD COMPATIBLE: Handles legacy workspaces with flat fields.
# 4. INCLUDES: org_id mapping and document/event/alert counts.
# 5. STATUS: Ready for replacement.
...
def _map_workspace_document(ws_doc: Dict[str, Any], db: Optional[Database] = None) -> Optional[Dict[str, Any]]:
    ...
    try:
        ...
        # Extract flat versions for frontend compatibility (even if client is None)
