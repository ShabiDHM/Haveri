...
// PHOENIX PROTOCOL - TYPES V3.6 (CRITICAL TYPE SYNC)
// 1. FIX: Explicitly exported 'EventPriority' to resolve TS2305 in CalendarPage.
// 2. UNIFICATION: All calendar interfaces now reference the central EventPriority type.
// 3. STATUS: Environment Integrity Validated.
