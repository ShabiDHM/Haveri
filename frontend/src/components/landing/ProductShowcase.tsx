...
// PHOENIX PROTOCOL - SHOWCASE V22.0 (DESIGN SYSTEM STANDARDIZED)
...
const ProductShowcase = () => {
    ...
    const features = [
        ...
        },
        {
            ...
            color: "from-danger-start to-danger-start/80",
    ...
    return (
        <div className="py-16 lg:py-24 bg-base relative overflow-hidden">
                            ...
                            <motion.div key={activeTab} initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} transition={{ duration: 0.4 }} className="absolute inset-0">
                                <div className="w-full h-full bg-card rounded-3xl border border-border-main shadow-xl overflow-hidden relative flex flex-col">
                                    <div className="h-10 bg-surface border-b border-border-main flex items-center px-4 gap-2">
                                        <div className="w-2.5 h-2.5 rounded-full bg-danger-start/40" />
                                        <div className="w-2.5 h-2.5 rounded-full bg-warning-start/40" />
                                        <div className="w-2.5 h-2.5 rounded-full bg-success-start/40" />
                                    </div>
                                    <div className="p-6 flex-1 bg-gradient-to-b from-surface to-base relative overflow-hidden flex items-center justify-center">
...
const DataAnalystMockup = () => (
    <div className="w-full max-w-sm p-5 bg-card border border-border-main rounded-2xl space-y-4">
        <div className="flex items-center gap-3">
            <div className="p-2.5 bg-primary-start/20 rounded-xl border border-primary-start/30"><FileSpreadsheet className="text-primary" size={20} /></div>
...
const DualAgentMockup = () => (
    <div className="w-full max-w-sm space-y-4">
        ...
        <div className="flex gap-3 items-start flex-row-reverse">
            ...
            <div className="bg-success-start/10 border border-success-start/30 p-3 rounded-2xl rounded-tr-none text-xs text-success-start leading-relaxed">"Saktë. Neni 12 i ligjit për rregullat e shpenzimeve e konfirmon këtë."</div>
        </div>
    </div>
);
