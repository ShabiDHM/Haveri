...
// PHOENIX PROTOCOL - HEADER V5.1 (FINAL CLEANUP)
// 1. REMOVED: Deleted the BrandLogo from the left side again to prevent redundancy.
// 2. LAYOUT: Ensured the main navigation is the furthest-left element on desktop.
// 3. STATUS: Final header layout is now correct.
...
import BrandLogo from './BrandLogo'; // Keep import for mobile view
...
const Header: React.FC = () => {
  ...
  return (
    <header className="h-16 bg-background-dark/80 backdrop-blur-md border-b border-glass-edge flex items-center justify-between px-4 sm:px-6 z-40 sticky top-0">
      ...
      {/* Left side: Navigation (Desktop) / Brand (Mobile) */}
      <div className="flex items-center gap-6">
        {/* PHOENIX: Show BrandLogo only on mobile as the main nav is hidden */}
