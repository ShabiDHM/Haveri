            ...
            <div className="bg-background-dark border border-glass-edge rounded-2xl w-full max-w-2xl overflow-hidden flex flex-col max-h-[90vh]">
                    ...
                    {step === 'upload' && (
                        <div className="text-center py-10 space-y-4">
                            ...
                            <button 
                                ...
                                disabled={isLoading}
                                className="px-6 py-3 bg-emerald-600 hover:bg-emerald-700 text-white rounded-xl font-bold transition-all disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-2 mx-auto"
                            >
                        ...
                        <div className="space-y-6">
                            ...
                            <div className="space-y-4">
                                {requiredFields.map((field) => (
                                    <div key={field.key} className="flex items-center justify-between gap-4 bg-white/5 p-3 rounded-lg border border-white/5">
                ...
                {step === 'mapping' && (
                    <div className="p-6 border-t border-white/10 flex justify-end gap-3 bg-black/20">
                        <button onClick={() => setStep('upload')} className="px-4 py-2 text-gray-400 hover:text-white transition-colors">{t('finance.import.back')}</button>
                        <button 
                            onClick={handleConfirm}
                            disabled={!getMappedHeader('amount')} // Amount is mandatory
                            className="px-6 py-2 bg-emerald-600 hover:bg-emerald-700 disabled:bg-gray-700 disabled:text-gray-500 text-white rounded-lg font-bold flex items-center gap-2 transition-all"
                        >
                            <CheckCircle size={18} />
