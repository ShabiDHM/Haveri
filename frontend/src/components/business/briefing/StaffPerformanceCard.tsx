...
export const StaffPerformanceCard: React.FC<{ data?: StaffData }> = ({ data }) => {
    ...
    // Default Fallback to avoid crash if data is loading/missing
    const stats: StaffData = data || {
        efficiencyStatus: 'stable',
        efficiencyScore: 0,
        mvpName: '...',
        mvpTotal: 0,
        mvpInsight: 'Duke analizuar të dhënat...',
        actionBravo: false
    };

    // Dynamic styles based on Vibe
    ...
    const handleWhatsApp = () => {
        const text = `Bravo ${stats.mvpName}! Pashë që ke kapur rekordin sot me €${stats.mvpTotal}. Vazhdo kështu! 🚀`;
        ...
        >
            ...
            <div className="flex justify-between items-center z-10">
                <div className="flex items-center gap-3">
                    <div className={`p-2 rounded-xl ${getStatusColor(stats.efficiencyStatus)}`}>
                ...
                <div className="text-right">
                    ...
                    <p className="text-[10px] text-gray-500">Efiçenca</p>
                </div>
            </div>
            ...
            <div className="mt-6 bg-gradient-to-r from-gray-800/50 to-gray-800/30 rounded-2xl p-4 border border-white/5 flex items-center gap-4 z-10">
                ...
                <div className="flex-1">
                    ...
                    <p className="text-amber-300 text-sm font-bold">€{stats.mvpTotal} <span className="text-gray-500 text-xs font-normal">/ Sot</span></p>
                </div>
                <div>
