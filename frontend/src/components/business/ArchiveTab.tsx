...
// PHOENIX PROTOCOL - ARCHIVE TAB V16.0 (MOBILE OPTIMIZED)
// 1. UI: Adjusted ArchiveCard padding (p-4 mobile, p-6 desktop).
// 2. UI: Responsive grid gaps (gap-4 mobile, gap-6 desktop).
// 3. UI: Optimized Modal padding for small screens.
// 4. UI: Responsive typography for card titles.
