...
// PHOENIX PROTOCOL - TAX MODULE V13.7 (TOTAL STYLE OVERRIDE)
            ...
            <div className="relative overflow-hidden rounded-3xl border border-white/10 bg-white/[0.05] backdrop-blur-2xl p-6 shadow-2xl h-full flex flex-col min-h-[480px] hover-lift group">
                ...
                <div className="flex justify-between items-center border-b border-white/10 pb-5 mb-6 flex-shrink-0">
                    ...
                    <button 
                        ...
                        className="text-white/60 hover:text-white/90 transition-colors p-1 hover-lift shadow-sm" 
                ...
                <div className="flex flex-col flex-1 min-h-0">
                    ...
                    <div className="rounded-2xl border border-white/10 bg-black/10 backdrop-blur-md p-6 mb-4 flex-shrink-0 text-center flex flex-col justify-center items-center shadow-sm">
                        <p className="text-xs text-white/60 uppercase font-black tracking-widest mb-2 relative z-10">
                    ...
                    <div className="grid grid-cols-2 gap-4 mb-6 flex-shrink-0">
                        ...
                        <div className="relative rounded-2xl border border-white/10 bg-black/10 backdrop-blur-md p-4 text-center group/item hover:border-success-start/30 transition-all hover-lift shadow-sm">
                        ...
                        <div className="relative rounded-2xl border border-white/10 bg-black/10 backdrop-blur-md p-4 text-center group/item hover:border-danger-start/30 transition-all hover-lift shadow-sm">
