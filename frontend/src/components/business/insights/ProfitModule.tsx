                            ...
                            <div className="p-6 border-b border-white/10 bg-purple-900/20 flex justify-between items-start">
                                <div>
                                    <h3 className="text-xl font-bold text-white flex items-center gap-2">
                                        {selectedItem.name}
                                        <span className="text-xs bg-rose-500 text-white px-2 py-0.5 rounded-full">Kritike</span>
                                    </h3>
                                    ...
                                    <div className="space-y-6">
                                        ...
                                        <div className="bg-black/40 border border-white/10 rounded-xl p-4 relative overflow-hidden">
                                            ...
                                            <h4 className="text-sm font-bold text-blue-400 mb-2 flex items-center gap-2">
                                                <ShoppingCart size={16} /> Sugjerim për Rimbushje
                                            </h4>
                                            <p className="text-gray-300 text-sm mb-3 leading-relaxed">
                                                {aiData.prediction?.reason || "Based on sales velocity, stock will deplete soon."}
                                            </p>
                                        ...
                                        <div className="bg-black/40 border border-white/10 rounded-xl p-4 relative overflow-hidden">
                                            ...
                                            <h4 className="text-sm font-bold text-emerald-400 mb-2 flex items-center gap-2">
                                                <TrendingUp size={16} /> Analiza e Trendit
                                            </h4>
