                ...
                {selectedItem && !showPOModal && (
                    <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 backdrop-blur-md">
                        <motion.div initial={{ scale: 0.9, y: 20 }} animate={{ scale: 1, y: 0 }} exit={{ scale: 0.9, y: 20 }} className="bg-glass backdrop-blur-xl border border-primary/30 rounded-2xl w-full max-w-lg shadow-xl overflow-hidden relative">
                            <div className="p-6 border-b border-border-main bg-primary/20 flex justify-between items-start">
                                <div>
                                    ...
                                    <div className="space-y-6">
                                        <div className="bg-surface border border-primary/20 rounded-xl p-4 relative overflow-hidden shadow-sm">
                                            ...
                                            <button 
                                                ...
                                                className="w-full mt-3 py-2.5 btn-primary rounded-lg text-sm flex items-center justify-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed"
                                            >
                                        ...
                                        <div className="bg-surface border border-success-start/20 rounded-xl p-4 relative overflow-hidden shadow-sm">
                                            ...
                                            <div className="space-y-3">
                                                <div>
                                                    <p className="text-[10px] text-text-muted uppercase font-black mb-1 tracking-widest">{t('inventory.analysis.performance', 'Performance')}</p>
                                                ...
                                                <div className="pt-2 border-t border-border-main">
                                                    <p className="text-[10px] text-text-muted uppercase font-black mb-1 tracking-widest">{t('inventory.analysis.crossSell', 'Mundësi Cross-Sell')}</p>
                     ...
                     <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} className="fixed inset-0 z-[60] flex items-center justify-center p-4 bg-black/50 backdrop-blur-md">
                        <motion.div initial={{ scale: 0.9, y: 20 }} animate={{ scale: 1, y: 0 }} exit={{ scale: 0.9, y: 20 }} className="bg-glass backdrop-blur-xl border border-primary/30 rounded-2xl w-full max-w-lg shadow-xl overflow-hidden relative">
                            <div className="p-6 border-b border-border-main">
                                <h3 className="text-xl font-bold text-text-primary">{t('inventory.poModal.title', 'Konfirmo Porosinë')}</h3>
                            ...
                            <div className="p-6 bg-surface/30 flex justify-end gap-3">
                                <button onClick={() => setShowPOModal(false)} className="btn-secondary px-5 py-2.5">
                                    {t('general.cancel')}
                                </button>
                                <button 
