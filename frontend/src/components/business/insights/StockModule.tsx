                ...
                {selectedItem && !showPOModal && (
                    ...
                    >
                        <motion.div 
                            ...
                            className="relative rounded-3xl border border-gray-200 dark:border-white/10 bg-white/80 dark:bg-black/90 backdrop-blur-2xl w-full max-w-lg shadow-2xl overflow-hidden"
                        >
                            <div className="p-6 sm:p-8 border-b border-gray-200 dark:border-white/10 flex justify-between items-start">
                                <div>
                                    <h3 className="text-gray-900 dark:text-white font-black uppercase tracking-widest flex items-center gap-3 mb-2">
                                        {selectedItem.name}
                                        <span className="text-xs bg-rose-500/20 dark:bg-rose-400/20 border border-rose-500/30 dark:border-rose-400/30 text-rose-600 dark:text-rose-400 px-2 py-0.5 rounded uppercase font-black tracking-widest">
                                            {t('inventory.analysis.critical', 'Kritike')}
                                        </span>
                                    </h3>
                                    <p className="text-gray-500 dark:text-white/50 text-xs uppercase font-black tracking-widest">
                                        {t('inventory.analysis.currentStock', 'Stoku Aktual')}: {selectedItem.current_stock} {selectedItem.unit}
                                    </p>
                                </div>
                                <button onClick={() => setSelectedItem(null)} className="p-2 hover:bg-gray-100 dark:hover:bg-white/10 rounded-lg text-gray-500 dark:text-white/50 transition-colors">
                                    <X size={20}/>
                                </button>
                            </div>
                            ...
                            <div className="p-6 sm:p-8 min-h-[280px]">
                                {loading ? (
                                    <div className="flex flex-col items-center justify-center py-12 space-y-4 text-center">
                                        ...
                                        <p className="text-gray-500 dark:text-white/50 text-xs uppercase font-black tracking-widest animate-pulse">
                                            {t('inventory.analysis.analyzing', 'Inteligjenca Artificiale po analizon...')}
                                        </p>
                                    </div>
                                ) : (
                                    <div className="space-y-6">
                                        <div className="relative border border-gray-200 dark:border-white/10 bg-white/50 dark:bg-white/5 rounded-2xl p-5">
                                            ...
                                            <p className="text-gray-700 dark:text-white/70 text-xs mb-4 leading-relaxed font-medium">
                                            ...
                                            <button 
                                                ...
                                                className="w-full h-12 rounded-xl bg-white/80 dark:bg-white/5 border border-gray-200 dark:border-white/10 text-gray-800 dark:text-white hover:bg-white dark:hover:bg-white/10 transition-all backdrop-blur-sm font-bold uppercase tracking-widest text-xs flex items-center justify-center gap-2 disabled:opacity-40"
                                            >
                                        ...
                                        <div className="relative border border-gray-200 dark:border-white/10 bg-white/50 dark:bg-white/5 rounded-2xl p-5">
                                            ...
                                            <p className="text-gray-700 dark:text-white/70 text-xs font-medium leading-relaxed">
                                            ...
                                            {aiData.trend?.cross_sell_opportunities && (
                                                <div className="mt-4 pt-4 border-t border-gray-200 dark:border-white/10">
                                                    <p className="text-gray-500 dark:text-white/50 text-xs uppercase font-black tracking-widest mb-2">
                ...
                {showPOModal && selectedItem && (
                    ...
                    >
                        <motion.div 
                            ...
                            animate={{ scale: 1, y: 0 }} 
                            exit={{ scale: 0.98, y: 20 }} 
                            className="relative overflow-hidden rounded-3xl border border-gray-200 dark:border-white/10 bg-white/80 dark:bg-black/90 backdrop-blur-2xl w-full max-w-lg shadow-2xl"
                        >
                            <div className="p-6 sm:p-8 border-b border-gray-200 dark:border-white/10">
                                <h3 className="text-gray-900 dark:text-white font-black uppercase tracking-widest mb-2">
                            ...
                            <div className="p-6 sm:p-8 space-y-6">
                                <div>
                                    <label className="block text-gray-500 dark:text-white/50 text-xs font-black uppercase tracking-widest mb-2">
                                        {t('inventory.poModal.supplierName', 'Emri i Furnitorit')}
                                    </label>
                                    <textarea 
                                        value={poSupplier} 
                                        onChange={(e) => setPoSupplier(e.target.value)}
                                        className="rounded-2xl border border-gray-200 dark:border-white/10 bg-white/50 dark:bg-white/5 backdrop-blur-md w-full p-4 h-24 resize-none text-sm text-gray-800 dark:text-white/90 placeholder:text-gray-400 dark:placeholder:text-white/30 focus:border-primary-start focus:ring-1 focus:ring-primary-start/40 transition-all"
                                ...
                                <div className="grid grid-cols-2 gap-4">
                                    <div>
                                        ...
                                        <input 
                                            ...
                                            className="rounded-2xl border border-gray-200 dark:border-white/10 bg-white/50 dark:bg-white/5 backdrop-blur-md w-full p-4 text-sm text-gray-800 dark:text-white/90 focus:border-primary-start focus:ring-1 focus:ring-primary-start/40 transition-all"
                                        />
                                    </div>
                                    <div>
                                        <label className="block text-gray-500 dark:text-white/50 text-xs font-black uppercase tracking-widest mb-2">
                                        ...
                                        <input 
                                            ...
                                            className="rounded-2xl border border-gray-200 dark:border-white/10 bg-white/50 dark:bg-white/5 backdrop-blur-md w-full p-4 text-sm font-mono text-gray-800 dark:text-white/90 focus:border-primary-start focus:ring-1 focus:ring-primary-start/40 transition-all"
                                        />
                                    </div>
                                </div>
                            </div>
                            
                            <div className="p-6 sm:p-8 border-t border-gray-200 dark:border-white/10 flex justify-end gap-3 bg-white/50 dark:bg-white/5 backdrop-blur-sm">
                                <button 
                                    onClick={() => setShowPOModal(false)} 
                                    className="px-6 h-12 rounded-xl text-xs uppercase font-black tracking-widest text-gray-700 dark:text-white/70 hover:text-gray-900 dark:hover:text-white hover:bg-gray-100 dark:hover:bg-white/10 transition-colors"
                                >
                                ...
                                <button 
                                    ...
                                    disabled={drafting} 
                                    className="h-12 rounded-xl bg-indigo-600 dark:bg-indigo-500/20 border border-indigo-600 dark:border-indigo-500/30 text-white dark:text-indigo-300 hover:bg-indigo-700 dark:hover:bg-indigo-500/30 transition-all font-bold uppercase tracking-widest text-xs flex items-center justify-center gap-2 disabled:opacity-40 px-6"
                                >
