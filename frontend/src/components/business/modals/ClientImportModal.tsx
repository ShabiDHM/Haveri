        ...
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50 p-4 animate-in fade-in duration-200">
            <div className="bg-glass backdrop-blur-xl border border-success-start/20 rounded-3xl w-full max-w-md p-6 shadow-xl">
                ...
                <div className="text-center mb-8">
                    ...
                    <p className="text-text-muted text-sm max-w-[80%] mx-auto leading-relaxed">
                ...
                <div className="mb-8">
                    ...
                    >
                        {file ? (
                            <>
                                <CheckCircle size={32} className="text-success-start drop-shadow-lg" />
                                <span className="text-success-start font-bold text-sm px-4 truncate max-w-full">{file.name}</span>
                            </>
                        ) : (
                            <>
                                <div className="p-3 bg-surface rounded-full group-hover:scale-110 transition-transform">
                                    <Upload size={24} className="text-text-muted group-hover:text-success-start transition-colors" />
                                </div>
