            ...
            <header className="sticky top-0 z-50 bg-[#020617]/80 backdrop-blur-xl border-b border-white/5">
                <div className="max-w-6xl mx-auto px-6 py-4 flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-2 text-[10px] font-bold text-emerald-400 bg-emerald-500/5 px-3 py-1.5 rounded-full border border-emerald-500/10 shadow-[0_0_10px_rgba(16,185,129,0.1)]">
                        <ShieldCheck size={12} />
                        <span className="hidden sm:inline uppercase tracking-wider">{t('portal.secure_connection')}</span>
                    </div>
                </div>
            </header>
                        ...
                        <div className="relative bg-[#0f172a]/80 backdrop-blur-xl border border-white/10 rounded-3xl p-8 sm:p-10 shadow-2xl">
                            <div className="flex items-start justify-between mb-6">
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        <h3 className="text-sm font-bold text-white uppercase tracking-wider">Njoftim Zyrtar</h3>
                                        <p className="text-[10px] text-emerald-400 font-mono mt-0.5 uppercase tracking-widest">Nga Drejtoria</p>
                                    </div>
                                </div>
                ...
                <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.3 }}>
                    <div className="flex items-center justify-between mb-8 border-b border-white/5 pb-4">
                        <div className="flex items-center gap-4">
                            <div className="h-8 w-1 bg-gradient-to-b from-blue-500 to-emerald-500 rounded-full" />
                            <h2 className="text-2xl font-bold text-white tracking-tight">{t('portal.documents')}</h2>
                        </div>
                        <span className="bg-white/5 border border-white/10 text-gray-400 px-3 py-1 rounded-full text-xs font-mono">{data.documents.length} skedarë</span>
                    </div>
