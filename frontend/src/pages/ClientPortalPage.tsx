...
// PHOENIX PROTOCOL - PORTAL V9.0 (DESIGN SYSTEM ALIGNMENT)
...
// 3. FIXED: Updated API calls to use the /workspace prefix and correct parameter names.
// 4. CLEANUP: Removed unused 'businessNui' variable.
    ...
    const InfoRow = ({ icon: Icon, label, value, isLink = false }: { icon: any, label: string, value?: string, isLink?: boolean }) => {
        ...
        return (
            <div className="flex items-start gap-5 relative group">
                <div className="relative z-10 p-3 rounded-xl bg-surface border border-border-main text-primary shadow-sm group-hover:border-primary/30 group-hover:text-primary-hover transition-all duration-300 shrink-0">
