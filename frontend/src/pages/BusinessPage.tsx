...
// PHOENIX PROTOCOL - BUSINESS PAGE V9.7 (TITLE CASE FIX)
// 1. FIX: Updated 'capitalize' helper to format every word in the username (Title Case).
// 2. RESULT: "shaban bala" now correctly displays as "Shaban Bala".
