...
// PHOENIX PROTOCOL - LAW VIEWER V5.1 (ADAPTED FOR SECOND APP)
    ...
    return (
      <div className="max-w-3xl mx-auto px-6 pt-32">
        <div className="glass-panel border border-danger-start/30 bg-danger-start/5 p-10 rounded-[2rem] flex flex-col items-center text-center shadow-sm">
          ...
          <button onClick={handleBack} className="btn-primary flex items-center gap-2 hover-lift shadow-sm">
            <ArrowLeft size={18} />
  ...
  return (
    ...
    >
      <div className="max-w-4xl mx-auto px-6 sm:px-8 pt-28">
        ...
        <div className="glass-panel p-0 flex flex-col overflow-hidden shadow-sm border-border-main">
          ...
          <div className="bg-canvas px-8 sm:px-12 py-12 shadow-[inset_0_2px_12px_rgba(0,0,0,0.03)]">
