...
// PHOENIX PROTOCOL - LAW SEARCH V5.1 (REMOVED UNUSED IMPORT)

import { useState, useEffect, useCallback, useRef, useMemo } from 'react';
import { useTranslation } from 'react-i18next';
import { Search, X, BookOpen, AlertCircle, ChevronRight, ChevronDown, Loader2, Scale, Filter } from 'lucide-react'; // Removed FileText
import { useNavigate } from 'react-router-dom';
import { apiService, LawSearchResult } from '../services/api';
import { motion, AnimatePresence } from 'framer-motion';

// Use imported type
type LawResult = LawSearchResult;
