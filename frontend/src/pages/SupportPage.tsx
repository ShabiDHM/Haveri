...
// PHOENIX PROTOCOL - SUPPORT PAGE V21.0 (DESIGN SYSTEM STANDARDIZED)
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 auto-rows-fr">
          ...
          <div className="flex flex-col gap-8">
            <div className="glass-panel p-8 flex-1 flex flex-col">
              ...
              <div className="space-y-6 text-text-secondary text-lg">
                <div className="flex items-center gap-4">
                    <div className="p-3 bg-primary/10 rounded-xl border border-primary-start/30 text-primary"><Phone /></div>
                    <span>+383 44 987 898</span>
                </div>
                <div className="flex items-center gap-4">
                    <div className="p-3 bg-primary/10 rounded-xl border border-primary-start/30 text-primary"><MapPin /></div>
            ...
            <div className="glass-panel p-8 flex-1 flex flex-col">
              ...
              <button 
                ...
                className="w-full flex justify-center items-center gap-3 py-3 rounded-xl bg-primary/10 text-primary font-bold hover:bg-primary/20 transition-all border border-primary-start/30"
              >
          ...
          <div className="glass-panel p-8">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <button type="submit" disabled={isSubmitting} className="btn-primary w-full flex justify-center items-center gap-3 py-4 rounded-xl disabled:opacity-50">
